...
app.get("/digipet/train", (req, res) => {
  if (getDigipet()) {
    trainDigipet();
    res.json({
      message: "You trained your digipet. It has more discipline now!",
      digipet: getDigipet(),
    });
  } else {
    res.json({
...
app.get("/digipet/ignore", (req, res) => {
  if (getDigipet()) {
    ignoreDigipet();
    res.json({
      message: "You ignored your digipet. It has less happiness, nutrition and discipline!",
      digipet: getDigipet(),
    });
  } else {
    res.json({
...
app.get("/digipet/rehome", (req, res) => {
  if (getDigipet()) {
    rehomeDigipet();
    res.json({
      message: "You rehomed your digipet! Hatch a new one!",
      digipet: getDigipet(),
    });
  } else {
    res.json({
